import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-ISSSBINN.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-2XQIV77S.js";
import {
  LimitsModal
} from "./chunk-FYOLAUSG.js";
import {
...
} from "./chunk-HHD7VPTW.js";
import {
  useTypedSelector
} from "./chunk-AAWPZEY3.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-GP2OQMER.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-OC66G6BN.js";
import {
  index
} from "./chunk-QNDS5MAJ.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-BJB2AGKV.js";
import {
  useConfig,
  useTracking
} from "./chunk-TALJCMO3.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer2,
  require_baseUniq
} from "./chunk-RDF26WBS.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-SKDCDLGO.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-6ISP7W7Y.js";
import {
  renderAdmin
} from "./chunk-AHJXFEMS.js";
import {
  useAIAvailability
} from "./chunk-5QC3AUNK.js";
import {
  useLicenseLimits
} from "./chunk-B7NKGASL.js";
import {
  Table,
  useTable
} from "./chunk-MTB765FZ.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-3WLE3G5D.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-ASJ6ZPTL.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-EJKXVGLP.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-DY5NHXD4.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-3YYP3HQZ.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-CNSBFVNH.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-RJRWO6NI.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-QCDQZQSI.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-5RNXMIND.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-RFOOXUTR.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-TSY24GZU.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-N6DKBDCU.js");
          return {
...
//# sourceMappingURL=chunk-YWVUOGFN.js.map
