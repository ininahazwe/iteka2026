import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-XVFSUFA4.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-BKRI2GWK.js";
import {
  LimitsModal
} from "./chunk-BJ5GMF6C.js";
import {
...
} from "./chunk-XSVHOB6T.js";
import {
  useTypedSelector
} from "./chunk-T5UHSMNR.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-UN6HRZB3.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-C4HRYBZZ.js";
import {
  index
} from "./chunk-2APZATMQ.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-WVLMQC3D.js";
import {
  useConfig,
  useTracking
} from "./chunk-HQCOITIP.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer2,
  require_baseUniq
} from "./chunk-XMI62SEC.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-CAMU244J.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-5HA6MWGM.js";
import {
  renderAdmin
} from "./chunk-ATXU6QIE.js";
import {
  useAIAvailability
} from "./chunk-VD6SX5TH.js";
import {
  useLicenseLimits
} from "./chunk-L5IUR2E2.js";
import {
  Table,
  useTable
} from "./chunk-JD2ZDL2F.js";
import {
  useField,
  useForm
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-NQTUXAHX.js");
    case "./translations/cs.json":
      return import("./cs.json-BVIOKZG5.js");
    case "./translations/de.json":
      return import("./de.json-B3323KEV.js");
    case "./translations/dk.json":
      return import("./dk.json-5NZGFB5W.js");
    case "./translations/en.json":
      return import("./en.json-5VQTSX5I.js");
    case "./translations/es.json":
      return import("./es.json-IZ2FWFHQ.js");
    case "./translations/fr.json":
      return import("./fr.json-RFHE4FBW.js");
    case "./translations/id.json":
      return import("./id.json-DSKLKXJR.js");
    case "./translations/it.json":
      return import("./it.json-DNRQAWUE.js");
    case "./translations/ja.json":
      return import("./ja.json-FEZHHJK3.js");
    case "./translations/ko.json":
      return import("./ko.json-NR6DALKO.js");
    case "./translations/ms.json":
      return import("./ms.json-IWAYLSJH.js");
    case "./translations/nl.json":
      return import("./nl.json-BZBO4OWF.js");
    case "./translations/pl.json":
      return import("./pl.json-RO4PCYOF.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-XFKY2WOB.js");
    case "./translations/pt.json":
      return import("./pt.json-VJORCBNU.js");
    case "./translations/ru.json":
      return import("./ru.json-KC2UDUJP.js");
    case "./translations/sk.json":
      return import("./sk.json-AYTZUDD3.js");
    case "./translations/sv.json":
      return import("./sv.json-FU6UP3L5.js");
    case "./translations/th.json":
      return import("./th.json-CYTKBTRE.js");
    case "./translations/tr.json":
      return import("./tr.json-KHIUQSRB.js");
    case "./translations/uk.json":
      return import("./uk.json-7BPFSGFV.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-NTMNM6K7.js");
    case "./translations/zh.json":
      return import("./zh.json-USV63NZK.js");
    default:
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-GVTOI2BW.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-QU5RSSHS.js").then((mod) => ({
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-HK7JDGMG.js");
    case "./translations/es.json":
    ...
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-FTG3K6EF.js");
    case "./translations/pt.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-SCHQJGXD.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-LU2KLLXO.js");
        return {
...
function __variableDynamicImportRuntime1__3(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-7XZ5BBWU.js");
    case "./translations/es.json":
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-CCWHI5Y5.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-USZMJOYQ.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-7MAGFFEO.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-XSEGF7AA.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-JIDIYRC7.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-3D4KEI55.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-ZXI2YF2P.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-KRGIQCH4.js");
          return {
...
//# sourceMappingURL=chunk-BM2P3264.js.map
