...
function se(t) {
  ...
  return true ? new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(t, " for more information.").concat(n.length > 0 ? " Args: ".concat(n.join(", ")) : "")) : new Error(re.apply(void 0, __spreadArray([oe[t]], n, false)).trim());
}
var ie = function() {
  function e(e2) {
...
var Ue = function() {
  function e(e2, t, n) {
    this.rules = e2, this.staticRulesId = "", this.isStatic = (void 0 === n || n.isStatic) && We(e2), this.componentId = t, this.baseHash = D(He, t), this.baseStyle = n, Ae.registerId(t);
  }
...
function tt(e, s, i) {
  ...
  }(s.displayName, s.parentComponentId) : f2, y = s.displayName, v = void 0 === y ? function(e2) {
    return k(e2) ? "styled.".concat(e2) : "Styled(".concat(x(e2), ")");
  }(e) : y, N2 = s.displayName && s.componentId ? "".concat(A(s.displayName), "-").concat(s.componentId) : s.componentId || m2, C2 = a2 && c2.attrs ? c2.attrs.concat(p2).filter(Boolean) : p2, P2 = s.shouldForwardProp;
  ...
  function D2(e2, s2) {
    return function(e3, s3, i2) {
      var a3 = e3.attrs, c3 = e3.componentStyle, u3 = e3.defaultProps, l2 = e3.foldedComponentIds, d3 = e3.styledComponentId, p3 = e3.target, f3 = h ? void 0 : import_react.default.useContext(Je), m3 = Ve(), y2 = e3.shouldForwardProp || m3.shouldForwardProp;
      var v2 = b(s3, f3, u3) || w, g = function(e4, n, o2) {
      ...
      }(a3, s3, v2), S2 = g.as || p3, N3 = {};
      for (var C3 in g) void 0 === g[C3] || "$" === C3[0] || "as" === C3 || "theme" === C3 && g.theme === v2 || ("forwardedAs" === C3 ? N3.as = g.forwardedAs : y2 && !y2(C3, S2) || (N3[C3] = g[C3], y2 || true));
      var A2 = function(e4, t) {
        var n = Ve(), r2 = e4.generateAndInjectStyles(t, n.styleSheet, n.stylis);
        return false, r2;
      }(c3, g), P3 = A2.className, _3 = A2.css;
      var I3 = K(l2, d3);
      P3 && (I3 += " " + P3), g.className && (I3 += " " + g.className), N3[k(S2) && !E.has(S2) ? "class" : "className"] = I3, i2 && (N3.ref = i2);
  ...
  return T2.attrs = C2, T2.componentStyle = O2, T2.displayName = v, T2.shouldForwardProp = P2, T2.foldedComponentIds = a2 ? K(c2.foldedComponentIds, c2.styledComponentId) : "", T2.styledComponentId = N2, T2.target = a2 ? c2.target : e, Object.defineProperty(T2, "defaultProps", { get: function() {
...
function ut(n) {
  ...
  var u2 = /* @__PURE__ */ new WeakMap(), l2 = function(e) {
    ...
    if (void 0 === s2 && (s2 = n2.styleSheet.allocateGSInstance(a2), u2.set(n2.styleSheet, s2)), false, false, ("undefined" == typeof window || !n2.styleSheet.server) && function(e2, n3, o2, r4, s3) {
    ...
    if (h) {
      ...
      if (f2) {
        var y = "".concat(a2, "-").concat(s2);
        return import_react.default.createElement("style", { key: y, "data-styled-global": a2, precedence: "styled-components", href: y, children: f2 });
      }
    }
    return null;
  };
...
function dt(e) {
  var n = import_react.default.forwardRef(function(n2, r2) {
    ...
    return false, import_react.default.createElement(e, __assign(__assign({}, n2), { theme: s, ref: r2 }));
  });
...
//# sourceMappingURL=chunk-3X5RBWNZ.js.map
