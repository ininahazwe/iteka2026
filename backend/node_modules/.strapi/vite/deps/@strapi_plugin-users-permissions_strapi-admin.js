...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-FK2WROOS.js");
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: () => import("./Roles-5PG6IHT7.js"),
      ...
      },
      {
        ...
        Component: () => import("./Providers-APF4VTZ6.js"),
      ...
      },
      {
        ...
        Component: () => import("./EmailTemplates-DB6WRWPH.js").then((mod) => ({
      ...
      },
      {
        ...
        Component: () => import("./AdvancedSettings-PD4VYNH6.js").then((mod) => ({
