...
var zhHans = {
  ...
  "attribute.blocks.description": "基於JSON的新型富文本編輯器",
  "attribute.text": "Text",
  ...
  "components.SelectComponents.displayed-value": "已選擇 {number, plural, =0 {# components} one {# component} other {# components}}",
  ...
  "error.contentType.singularName-equals-pluralName": "此數值不能與另一個內容類型的複數 API ID 相同",
  "error.contentType.pluralName-equals-singularName": "此數值不能與另一個內容類型的單數 API ID 相同",
  "error.contentType.pluralName-equals-collectionName": "此數值已被另一個內容類型使用",
  "error.contentTypeName.reserved-name": "這個內容類型名稱不可以在此專案內被使用，有可能會破壞其他功能",
  "error.validation.enum-duplicate": "不允取重複的值 (只考慮字母數字字符)",
  "error.validation.enum-empty-string": "不允許空字串",
  "error.validation.enum-regex": "有一個以上的數值無效。數值在首個數字前應先有英文字母。",
  "error.validation.minSupMax": "不能超過最大值",
  ...
  "form.attribute.item.uniqueField.v5.willBeDisabled": "目前唯一欄位在元件中運作不正常。如果您啟用此功能，欄位將被禁用直到問題修復。",
  "form.attribute.item.uniqueField.v5.disabled": "目前唯一欄位在元件中運作不正常。此欄位已被禁用直到問題修復。",
  ...
  "relation.oneToOne": "有一個並屬於一個",
  "relation.oneWay": "有一個",
  "table.button.no-fields": "新增欄位",
  "table.content.create-first-content-type.title": "沒有內容類型",
  "table.content.create-first-content-type.description": "創建集合類型、單一類型和元件以構建您的 schema。",
  "table.content.create-first-content-type.start-with-prompt": "從提示開始",
  "table.content.no-fields.collection-type": "向此集合型別新增首個欄位",
  "table.content.no-fields.component": "向此元件新增首個欄位",
  "IconPicker.search.placeholder.label": "搜尋圖示",
  "IconPicker.search.clear.label": "清除圖示搜尋",
  "IconPicker.search.button.label": "搜尋圖示按鈕",
  "IconPicker.remove.tooltip": "移除選定的圖示",
  "IconPicker.remove.button": "移除選定圖示按鈕",
  "IconPicker.emptyState.label": "未找到圖示",
  "IconPicker.icon.label": "選擇 {icon} 圖示",
  "chat.tooltips.close-chat": "關閉聊天",
  "chat.tooltips.create-chat": "新對話",
  "chat.tooltips.open-chat": "開啟聊天",
  "chat.tooltips.send-message": "發送",
  "chat.tooltips.stop-generation": "停止",
  "chat.header.default-title": "新對話",
  "chat.input.defaults.title": "我能幫您什麼？",
  "chat.input.defaults.generate": "生成產品 schema",
  "chat.input.defaults.ctb": "告訴我關於 Content-Type Builder",
  "chat.input.defaults.strapi": "告訴我關於 Strapi",
  "chat.input.thinking": "Strapi AI 正在思考...",
  "chat.input.placeholder": "詢問 Strapi AI...",
  "chat.input.strapi-ai-can-make-errors": "Strapi AI 可能會出錯。",
  "chat.messages.error": "出了點問題。",
  "chat.code-upload.header": "導入 Next.js 應用",
  "chat.code-upload.title": "導入 Next.js 應用",
  "chat.code-upload.description": "您的應用將被 AI 分析。請確保在導入前刪除所有敏感數據。",
  "chat.code-upload.drop-zone": "在此處放置 .zip 文件或",
  "chat.code-upload.drop-zone-browse": "瀏覽文件"
};
export {
  configurations,
  zhHans as default,
...
//# sourceMappingURL=zh-Hans.json-NTMNM6K7.js.map
