...
export interface ApiActualiteActualite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    article_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    author: Schema.Attribute.String;
    category: Schema.Attribute.Enumeration<
      ['Press', 'Event', 'Achievement', 'Announcement']
    >;
...
export interface ApiDonationCampaignDonationCampaign
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.Enumeration<['USD', 'EUR', 'RWF']>;
...
export interface ApiFestivalFestival extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    program_pdf: Schema.Attribute.Media<'files'>;
    publishedAt: Schema.Attribute.DateTime;
    registration_url: Schema.Attribute.String;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Iteka African Culture Festival'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGalleryGallery extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Events', 'Programmes', 'Festival', 'Team', 'Community']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    partnership_type: Schema.Attribute.Enumeration<
      ['Financial', 'Technical', 'Strategic']
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProgrammeProgramme extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    featured_image: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    gallery: Schema.Attribute.Media<'images' | 'videos', true>;
    impact_stats: Schema.Attribute.Component<'stats.impact-stat', true>;
    is_featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
